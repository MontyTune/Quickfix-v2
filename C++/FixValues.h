...
namespace FIX
{
  ...
  const char MsgType_RequestForPosition[] = "UAN";
  const char MsgType_GatewayStatusRequest[] = "UAR";
  const char MsgType_GatewayStatus[] = "UAT";
  ...
  const char OpenClose_FIFO = 'F';
  const char OpenClose_MANUAL_FILL = 'M';
  ...
  const int PartyRole_NON_EXECUTING_BROKER = 26;
  ...
  const int LastLiquidityIndicator_ADDED_LIQUIDITY = 1;
  const int LastLiquidityIndicator_REMOVED_LIQUIDITY = 2;
  const int EventType_EXPIRY_DATE = 5;
  ...
  const int OrderOrigination_ORDER_RECEIVED_FROM_CUSTOMER_OR_ORIGINATED_WITHIN_FIRM = 4;
  const int OrderOrigination_ORDER_RECEIVED_FROM_DIRECT_OR_SPONSORED_ACCESS_CUSTOMER = 5;
  const int OrderOrigination_ORDER_RECEIVED_FROM_OTHER_NON_DEA = 99;
  const int PartyRoleQualifier_ALGORITHM = 22;
  const int PartyRoleQualifier_FIRM_OR_LEGAL_ENTITY = 23;
  const int PartyRoleQualifier_NATURAL_PERSON = 24;
  ...
  const int OrderAttributeType_SYSTEMATIC_INTERNALIZER_ORDER = 5;
  const char SMPInstruction_CANCEL_RESTING = 'O';
  const char SMPInstruction_CANCEL_NEW = 'N';
  const char SMPInstruction_CANCEL_BOTH_RESTING_INBOUND = 'B';
  const char SMPInstruction_CANCEL_INBOUND = 'I';
  const int TrdRegPublicationReason_ILQD = 4;
  const int TrdRegPublicationReason_SIZE = 5;
  const int TrdRegPublicationReason_LRGS = 6;
  const int TrdRegPublicationReason_XFPH = 33;
  const int TrdRegPublicationReason_TPAC = 34;
  const char SecuritySubType_UNKNOWN[] = "Unknown";
  const char SecuritySubType_STRANGLE[] = "Strangle";
  const char SecuritySubType_STRADDLE[] = "Straddle";
  const char SecuritySubType_GUTS[] = "Guts";
  const char SecuritySubType_LADDER[] = "Ladder";
  const char SecuritySubType_VOLA[] = "Volatility Trade";
  const char SecuritySubType_IRON_BUTTERFLY[] = "Iron BFly";
  const char SecuritySubType_BOX[] = "Box";
  const char SecuritySubType_COMBO[] = "Combo";
  const char SecuritySubType_2X1RATIO[] = "2X1 Ratio";
  const char SecuritySubType_CALLPUT[] = "Misc. Call/Put Spread";
  const char SecuritySubType_CONV_REVERS[] = "Conversion/Reversal";
  const char SecuritySubType_DIAG_CALENDAR[] = "Diag Calendar";
  const char SecuritySubType_STRAD_CALENDAR[] = "Strad Calendar";
  const char SecuritySubType_DIAG_STRAD_CAL[] = "Diag Strad Calendar";
  const char SecuritySubType_INTERPROD[] = "Inter-Product";
  const char SecuritySubType_CALENDAR[] = "Calendar";
  const char SecuritySubType_CONDOR[] = "Condor";
  const char SecuritySubType_BUTTERFLY[] = "Butterfly";
  const char SecuritySubType_STRIP[] = "Strip";
  const char SecuritySubType_PACK[] = "Pack";
  const char SecuritySubType_BUNDLE[] = "Bundle";
  const char SecuritySubType_SYNTH_CONV_REVERS[] = "Synthetic Conv/Rev";
  const char SecuritySubType_CALL_SPREAD_VERS_PUT[] = "Call Spread vs. Put";
  const char SecuritySubType_PUT_SPREAD_VERS_CALL[] = "Put Spread vs. Call";
  const char SecuritySubType_STRAD_VERS_CALLPUT[] = "Straddle vs. Call/Put";
  const char SecuritySubType_HEDGED_CALLPUT[] = "Hedged Call/Put Spread";
  const char SecuritySubType_HEDGED_STRAD[] = "Hedged Straddle";
  const char SecuritySubType_HEDGED_CALL_SPREAD_VERS_PUT[] = "Hedged Call Spread versus Put";
  const char SecuritySubType_HEDGED_PUT_SPREAD_VERS_CALL[] = "Hedged Put Spread versus Call";
  const char SecuritySubType_HEDGED_CALLPUT_LADDER[] = "Hedged Ladder";
  const char SecuritySubType_HEDGED_COMBO[] = "Hedged Combo";
  const char SecuritySubType_HEDGED_2X1RATIO[] = "Vol 1x2 Ratio";
  const char SecuritySubType_HEDGED_CALENDAR[] = "Vol Calendar";
  const char SecuritySubType_JELLY_ROLL[] = "Jelly Roll";
  const char SecuritySubType_IRON_CONDOR[] = "Iron Condor";
  const char SecuritySubType_OPTION_STRIP[] = "Option Strip";
  const char SecuritySubType_REDUCED_TICK_SPREAD[] = "Reduced Tick Spread";
  const char SecuritySubType_HEDGED_STRANGLE[] = "Hedged Strangle";
  const char SecuritySubType_FUTURE_SPREAD[] = "Spread";
  const char SecuritySubType_HEDGED_DIAG_CALENDAR[] = "Hedged Call/Put Diag Calendar Spread";
  const char SecuritySubType_HEDGED_STRAD_CALENDAR[] = "Hedged Straddle Calendar Spread";
  const char SecuritySubType_HEDGED_DIAG_STRAD_CAL[] = "Hedged Diagonal Straddle Calendar Spread";
  const char SecuritySubType_HEDGED_BUTTERFLY[] = "Hedged Butterfly";
  const char SecuritySubType_HEDGED_IRON_CONDOR[] = "Hedged Iron Condor";
  const char SecuritySubType_HEDGED_CONDOR[] = "Hedged Condor";
  const char SecuritySubType_HEDGED_IRON_BUTTERFLY[] = "Hedged Iron Butterfly";
  const char SecuritySubType_HEDGED_GUTS[] = "Hedged Guts";
  const char SecuritySubType_CABINET[] = "Cabinet";
  const char SecuritySubType_HEDGED_CONV_REVERS[] = "Conversion/Reversal vs. Short U/L";
  const char SecuritySubType_BUY_WRITE[] = "Buy/Write";
  const char SecuritySubType_VERTICAL[] = "Vertical";
  const char SecuritySubType_CUSTOM_MARKET[] = "Custom Market";
  const char SecuritySubType_COVERED[] = "Covered";
  const char SecuritySubType_HORIZONTAL[] = "Horizontal";
  const char SecuritySubType_XMAS_TREE[] = "X-Mas Tree";
  const char SecuritySubType_RISK_REVERSAL[] = "Risk Reversal";
  const char SecuritySubType_HORIZONTAL_STRADDLE[] = "Horizontal Straddle";
  const char SecuritySubType_DOUBLE[] = "Double";
  const char SecuritySubType_COND_CURVE[] = "Conditional Curve";
  const char SecuritySubType_STRADDLE_STRIP[] = "Straddle Strip";
  const char SecuritySubType_3WAY[] = "3-Way";
  const char SecuritySubType_1X2RATIO[] = "1x2 Ratio";
  const char SecuritySubType_1X3RATIO[] = "1x3 Ratio";
  const char SecuritySubType_2X3RATIO[] = "2x3 Ratio";
  const char SecuritySubType_PACK_BUTTERFLY[] = "Pack Butterfly";
  const char SecuritySubType_DOUBLE_BUTTERFLY[] = "Double Butterfly";
  const char SecuritySubType_MONTH_PACK[] = "Month vs. Pack";
  const char SecuritySubType_CRACK[] = "Crack";
  const char SecuritySubType_HEDGED_VERTICAL[] = "Hedged Vertical";
  const char SecuritySubType_HEDGED_HORIZONTAL[] = "Hedged Horizontal";
  const char SecuritySubType_HEDGED_XMAS_TREE[] = "Hedged X-Mas Tree";
  const char SecuritySubType_HEDGED_STRIP[] = "Hedged Strip";
  const char SecuritySubType_HEDGED_RISK_REVERSAL[] = "Hedged Risk Reversal";
  const char SecuritySubType_HEDGED_HORIZONTAL_STRADDLE[] = "Hedged Horizontal Straddle";
  const char SecuritySubType_HEDGED_DOUBLE[] = "Hedged Double";
  const char SecuritySubType_HEDGED_COND_CURVE[] = "Hedged Conditional Curve";
  const char SecuritySubType_HEDGED_STRADDLE_STRIP[] = "Hedged Straddle Strip";
  const char SecuritySubType_HEDGED_3WAY[] = "Hedged 3-Way";
  const char SecuritySubType_HEDGED_BOX[] = "Hedged Box";
  const char SecuritySubType_TAILOR_MADE[] = "Tailor Made Combinations";
  const char SecuritySubType_ICS[] = "ICS";
  const char SecuritySubType_NON_STANDARD_COMBINATION[] = "Non Standard Combination";
  const char SecuritySubType_3WAY_CALL[] = "3-Way Straddle vs. Call";
  const char SecuritySubType_3WAY_PUT[] = "3-Way Straddle vs. Put";
  const char SecuritySubType_CUSTOM_CARRY[] = "Custom Carry";
  const char SecuritySubType_RRTCS[] = "Reverse Reduced Tick Calendar Spread";
  const int TrdType_Block_Trade = 1;
  const int TrdType_Exchange_For_Swap_EFS = 12;
  const int TrdType_Committed = 89;
  const int TrdType_Exchange_for_Physical_Equity_Index = 90;
  const int TrdType_Exchange_forPhysical_Fixed_Income = 91;
  const int TrdType_Cross = 92;
  const int TrdType_One_Sided = 93;
  const int TrdType_Against_Actual = 94;
  const int TrdType_Asset_Allocation = 95;
  const int TrdType_Basis = 96;
  const int TrdType_Guaranteed_Cross = 97;
  const int TrdType_Prof_Trade = 98;
  const int TrdType_Vola = 99;
  ...
  const char ManualOrderIndicator_Order_was_sent_manually = 'Y';
  const char ManualOrderIndicator_Order_was_generated_by_automated_trading_logic = 'N';
  const char SyntheticOrdStatus_Waiting[] = "N";
  const char SyntheticOrdStatus_Pending_Trigger[] = "T";
  const char SyntheticOrdStatus_Rejected[] = "J";
  const char SyntheticOrdStatus_Working[] = "W";
  const char SyntheticOrdStatus_Hold[] = "H";
  const char SyntheticOrdStatus_Paused[] = "P";
  const char SyntheticOrdStatus_Deleting[] = "E";
  const char SyntheticOrdStatus_Deleted[] = "D";
  const char SyntheticOrdStatus_Pulling[] = "L";
  const char SyntheticOrdStatus_Pausing[] = "S";
  const char SyntheticOrdStatus_Resuming[] = "M";
  const char SyntheticOrdStatus_Initializing[] = "I";
  const char SyntheticOrdStatus_Recovering[] = "R";
  const char SyntheticOrdStatus_Filled[] = "F";
  const char SyntheticOrdStatus_Expired[] = "X";
  const char SyntheticOrdStatus_Unmanaged[] = "U";
  const char SyntheticOrdType_Time_Slicer[] = "1";
  const char SyntheticOrdType_Time_Duration[] = "2";
  const char SyntheticOrdType_Volume_Slicer[] = "3";
  const char SyntheticOrdType_Volume_Duration[] = "4";
  const char SyntheticOrdType_Iceberg[] = "5";
  const char SyntheticOrdMod_Stop[] = "1";
  const char SyntheticOrdMod_If_Touched[] = "2";
  const char SyntheticOrdMod_Trailing_Stop[] = "3";
  const char SyntheticOrdMod_Trailing_If_Touched[] = "4";
  const char SyntheticOrdMod_Trailing_Limit[] = "5";
  const char SyntheticOrdMod_Machine_Gun[] = "6";
  const char StagedOrderStatus_Available = 'A';
  const char StagedOrderStatus_Owned = 'O';
  const char StagedRoutingLevel_Broker = 'B';
  const char StagedRoutingLevel_Internal = 'I';
  const char LinkType_SPREAD_QUOTING = '1';
  const char LinkType_SPREAD_HEDGE = '2';
  const char LinkType_SPREAD_POSITION_RESERVE = '3';
  const char LinkType_SYNTHETIC_CHILD = '5';
  const char LinkType_SYNTHETIC_CHILD_POSITION_RESERVE = '6';
  const char LinkType_STAGED_CHILD = '7';
  const char LinkType_ALGO_CHILD = 'A';
  const char LinkType_SPREAD_SNIPER = 'S';
  const char LinkType_UNKNOWN = 'U';
  const char RelativePriceType_LTP[] = "0";
  const char RelativePriceType_Bid[] = "1";
  const char RelativePriceType_Ask[] = "2";
  const char RelativePriceType_SameSide[] = "3";
  const char RelativePriceType_OppositeSide[] = "4";
  const char RelativePriceType_Trigger[] = "5";
  const char EndDateTimeAction_Cancel[] = "C";
  const char EndDateTimeAction_Market[] = "M";
  const char EndDateTimeAction_Leave[] = "L";
  const char WATType_Quantity[] = "1";
  const char WATType_Percentage[] = "2";
  const char TriggerPriceType_LTP = '0';
  const char TriggerPriceType_Bid = '1';
  const char TriggerPriceType_Ask = '2';
  const char TriggerPriceType_SameSide = '3';
  const char TriggerPriceType_OppositeSide = '4';
  ...
  const char TriggerQtyType_Absolute_Quantity[] = "1";
  const char TriggerQtyType_Percentage[] = "2";
  const char TriggerQtyOperator_Greater_Than_or_Equal_To[] = "0";
  const char TriggerQtyOperator_Less_Than_or_Equal_To[] = "1";
  const char TrailingPriceType_LTP[] = "0";
  const char TrailingPriceType_Bid[] = "1";
  const char TrailingPriceType_Ask[] = "2";
  const char TrailingPriceType_SameSide[] = "3";
  const char TrailingPriceType_OppositeSide[] = "4";
  const char SlicerIntervalUnit_Minutes[] = "1";
  const char SlicerIntervalUnit_Seconds[] = "2";
  const char SlicerIntervalUnit_Milliseconds[] = "3";
  const char DurationType_Time[] = "1";
  const char DurationType_Time_Intervale[] = "2";
  const char DurationType_Volume[] = "3";
  const char DurationUnit_Hours[] = "1";
  const char DurationUnit_Minutes[] = "2";
  const char DurationUnit_Seconds[] = "3";
  const char LeftActionTrigger_At_End[] = "0";
  const char LeftActionTrigger_Half_Life[] = "1";
  const char LeftAction_Leave[] = "0";
  const char LeftAction_Merge[] = "1";
  const char LeftAction_Market[] = "2";
  const char LeftAction_Payup[] = "3";
  const int PriceDisplayType_NORMAL = 0;
  const int PriceDisplayType_THIRTY_SECONDS = 15;
  const int PriceDisplayType_YIELD_PRICE_ONE = 2;
  const int PriceDisplayType_YIELD_PRICE_TWO = 3;
  const int PriceDisplayType_DISCOUNT = 4;
  const int PriceDisplayType_DECIMAL = 5;
  const int PriceDisplayType_BASIS = 6;
  const int PriceDisplayType_ROLL = 7;
  const int PriceDisplayType_SPREAD = 8;
  const int PriceDisplayType_512TH = 9;
  const int PriceDisplayType_HALF_CENTS = 10;
  const int PriceDisplayType_FOURTHS = 11;
  const int PriceDisplayType_MODIFIED_FOURTHS = 12;
  const int PriceDisplayType_EIGHTHS = 13;
  const int PriceDisplayType_MODIFIED_DECIMAL_FOURTHS = 14;
  const int PriceDisplayType_SIXTY_FOURTHS = 16;
  const int PriceDisplayType_HALF_THIRTY_SECONDS = 17;
  const int PriceDisplayType_QUARTER_THIRTY_SECONDS = 18;
  const int PriceDisplayType_HALF_SIXTY_FOURTHS = 19;
  const int PriceDisplayType_FIVES = 20;
  const int PriceDisplayType_HALF_POINTS = 21;
  const int PriceDisplayType_FIVE_ONE_THOUSANDTHS = 22;
  const int PriceDisplayType_ONE_HUNDRETHS = 23;
  const int PriceDisplayType_TENTHS = 24;
  const int PriceDisplayType_TEN_HUNDREDTHS_OF_A_CENT = 25;
  const int PriceDisplayType_NO_DECIMALS = 26;
  const int PriceDisplayType_MODIFIED_1_40_POINTS = 27;
  const int PriceDisplayType_EIGHTH_THIRTY_SECONDS = 28;
  const int PriceDisplayType_BROKERTEC_1_64 = 30;
  const int PriceDisplayType_BROKERTEC_2_8 = 31;
  const int PriceDisplayType_BROKERTEC_2_8_OF_1_32 = 32;
  const int PriceDisplayType_BROKERTEC_1_8_OF_1_32 = 33;
  const int PriceDisplayType_BROKERTEC_BOTH_1_100_AND_1_8 = 34;
  const int PriceDisplayType_BROKERTEC_NORMAL = 35;
  const int PriceDisplayType_BROKERTEC_POINTS_FFQ = 36;
  const int PriceDisplayType_BROKERTEC_32NDS_Q = 37;
  const int PriceDisplayType_QUARTER_32NDS_4X = 38;
  const int PriceDisplayType_QUARTER_32NDS_2X = 39;
  const int PriceDisplayType_BROKERTEC_YIELD = 40;
  const int PriceDisplayType_HALF_CENTS_2X = 41;
  const int PriceDisplayType_NORMAL_2X = 42;
  const int PriceDisplayType_NORMAL_5X = 43;
  const int PriceDisplayType_NORMAL_100X = 44;
  const int PriceDisplayType_FIVE_ONE_THOUSANDTHS_2X = 45;
  const int PriceDisplayType_FIVE_ONE_THOUSANDTHS_5X = 46;
  const int PriceDisplayType_FIVE_ONE_THOUSANDTHS_10X = 47;
  const int PriceDisplayType_TEN_HUNDREDTHS_2X = 48;
  const int PriceDisplayType_TEN_HUNDREDTHS_5X = 49;
  const int PriceDisplayType_TEN_HUNDREDTHS_10X = 50;
  const int PriceDisplayType_QUARTER_ONE_HUNDREDTHS = 51;
  const int PriceDisplayType_NORMAL_10X = 52;
  const int PriceDisplayType_NORMAL_50X = 53;
  const int PriceDisplayType_NORMAL_500X = 54;
  const int PriceDisplayType_NORMAL_25X = 55;
  const int PriceDisplayType_BTEC_INVERTED = 56;
  const int PriceDisplayType_1_16_OF_1_32 = 57;
  const char PassiveAggressive_PASSIVE = 'P';
  const char PassiveAggressive_AGGRESSIVE = 'A';
  const char AutoAggressive_AUTOAGRESSIVE_ORDER = 'Y';
  const char AutoAggressive_NONAUTOAGRESSIVE_ORDER = 'N';
  const int MDEntryState_NONE = 1;
  const int MDEntryState_PUBLIC_WORKUP_AGGRESSOR_HIT = 2;
  const int MDEntryState_PUBLIC_WORKUP_AGGRESSOR_TAKE = 3;
  const int MDEntryState_PRIVATE_WORKUP_AGGRESSOR_HIT = 4;
  const int MDEntryState_PRIVATE_WORKUP_AGGRESSOR_TAKE = 5;
  const char MDEntrySizeType_Minimum_Available[] = "1";
  const char MDEntrySizeType_Net_Aggregate[] = "2";
  const char MDEntrySizeType_Minimum_Availableand_Net_Aggregate[] = "1 2";
  const char AggressorSide_Buyer = '1';
  const char AggressorSide_Seller = '2';
  const char ExactNumOrdersIndicator_Yes = 'Y';
  const char ExactNumOrdersIndicator_No = 'N';
  const char DropCopyOrder_YES = 'Y';
  const char DropCopyOrder_NO = 'N';
  const int PosReqType_POSITIONS = 0;
  const int PosReqType_TRADES = 1;
  const int PosReqType_START_OF_DAYS = 4;
  const int PosReqType_MANUAL_FILLS = 5;
  const int PosReqType_DETAILED_START_OF_DAYS = 6;
  ...
  const char RequestTickTable_YES = 'Y';
  const char RequestTickTable_NO = 'N';
  const int ForceLogout_NOT_FORCED = 0;
  const int ForceLogout_FORCED = 1;
  const int GatewayStatus_HALTED = 1;
  const int GatewayStatus_OPEN = 2;
  const int GatewayStatus_CLOSED = 3;
  const int GatewayStatus_PRE_OPEN = 4;
  const int GatewayStatus_PRE_CLOSED = 5;
  const int SubExchangeGateway_PRICE = 1;
  const int SubExchangeGateway_ORDER = 2;
  const int SubExchangeGateway_FILL = 3;
  const char DeliveryTerm_DAY = 'D';
  const char DeliveryTerm_WEEK = 'W';
  const char DeliveryTerm_BALANCE_OF_MONTH = 'B';
  const char DeliveryTerm_QUARTER = 'Q';
  const char DeliveryTerm_SEASON = 'S';
  const char DeliveryTerm_YEAR = 'Y';
  const char DeliveryTerm_VARIABLE = 'V';
  const char DeliveryTerm_BALANCE_OF_WEEK = 'L';
  const char DeliveryTerm_CUSTOM = 'X';
  const char DeliveryTerm_SAME_DAY = 'A';
  const char DeliveryTerm_NEXT_DAY = 'N';
  const char UnderlyingDeliveryTerm_DAY = 'D';
  const char UnderlyingDeliveryTerm_WEEK = 'W';
  const char UnderlyingDeliveryTerm_BALANCE = 'B';
  const char UnderlyingDeliveryTerm_QUARTER = 'Q';
  const char UnderlyingDeliveryTerm_SEASON = 'S';
  const char UnderlyingDeliveryTerm_YEAR = 'Y';
  const char UnderlyingDeliveryTerm_VARIABLE = 'V';
  const char IncludeHistoricalFills_Yes = 'Y';
  const char IncludeHistoricalFills_No = 'N';
  const char IncludeNumberOfOrders_Yes = 'Y';
  const char IncludeNumberOfOrders_No = 'N';
