...
namespace FIX44
{
  ...
  public:
    ...
    {
    public:
    NoQuoteEntries() : FIX::Group(295,55,FIX::message_order(55,65,48,22,460,461,167,10762,200,541,201,224,225,239,226,227,228,255,543,470,471,472,240,202,947,206,231,223,207,106,348,349,107,350,351,691,667,875,876,873,874,913,914,915,918,788,916,917,919,898,711,555,0)) {}
      ...
      {
      public:
      NoSecurityAltID() : FIX::Group(454,10455,FIX::message_order(10455,456,0)) {}
      ...
      NoUnderlyings() : FIX::Group(711,311,FIX::message_order(311,312,309,305,462,463,310,763,313,542,315,241,242,243,244,245,246,256,595,592,593,594,247,316,941,317,436,435,308,306,362,363,307,364,365,877,878,318,879,810,882,883,884,885,886,0)) {}
        ...
        {
        public:
        NoUnderlyingSecurityAltID() : FIX::Group(457,10456,FIX::message_order(10456,459,0)) {}
      ...
      {
      public:
      NoLegs() : FIX::Group(555,600,FIX::message_order(600,601,602,603,607,608,609,764,610,611,248,249,250,251,252,253,257,599,596,597,598,254,612,942,613,614,615,616,617,618,619,620,621,622,623,16624,556,740,739,955,956,0)) {}
