...
class LastLiquidityIndicator(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
...
class OrderEnteredTime(quickfix.UtcTimeStampField):
	def __init__(self, data = None):
		if data == None:
			quickfix.UtcTimeStampField.__init__(self, 6038)
		else:
			quickfix.UtcTimeStampField.__init__(self, 6038, data)

class SelfMatchPreventionID(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 7928)
		else:
			quickfix.StringField.__init__(self, 7928, data)

class SMPInstruction(quickfix.CharField):
	def __init__(self, data = None):
		if data == None:
			quickfix.CharField.__init__(self, 8000)
		else:
			quickfix.CharField.__init__(self, 8000, data)

class TrdRegPublicationReason(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 8013)
		else:
			quickfix.IntField.__init__(self, 8013, data)

class TradingVenueRegulatoryTradeID(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 8016)
		else:
			quickfix.StringField.__init__(self, 8016, data)

class ExpectedFillType(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 10442)
		else:
			quickfix.IntField.__init__(self, 10442, data)
...
class FixingDate(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 10541)
		else:
			quickfix.StringField.__init__(self, 10541, data)

class TTUsername(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 10553)
		else:
			quickfix.StringField.__init__(self, 10553, data)
...
class OrigExecID(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16017)
		else:
			quickfix.StringField.__init__(self, 16017, data)

class TTSessionID(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16018)
		else:
			quickfix.StringField.__init__(self, 16018, data)

class SyntheticOrdStatus(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16101)
		else:
			quickfix.StringField.__init__(self, 16101, data)

class UserTag(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16104)
		else:
			quickfix.StringField.__init__(self, 16104, data)

class OrderTag(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16105)
		else:
			quickfix.StringField.__init__(self, 16105, data)

class StagedOrderMsg(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16106)
		else:
			quickfix.StringField.__init__(self, 16106, data)

class SyntheticOrdType(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16107)
		else:
			quickfix.StringField.__init__(self, 16107, data)

class SyntheticOrdMod(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16108)
		else:
			quickfix.StringField.__init__(self, 16108, data)

class StagedOrderStatus(quickfix.CharField):
	def __init__(self, data = None):
		if data == None:
			quickfix.CharField.__init__(self, 16109)
		else:
			quickfix.CharField.__init__(self, 16109, data)

class StagedOrderOwner(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16110)
		else:
			quickfix.StringField.__init__(self, 16110, data)

class StagedRoutingLevel(quickfix.CharField):
	def __init__(self, data = None):
		if data == None:
			quickfix.CharField.__init__(self, 16111)
		else:
			quickfix.CharField.__init__(self, 16111, data)

class FFT2(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16102)
		else:
			quickfix.StringField.__init__(self, 16102, data)

class FFT3(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16103)
		else:
			quickfix.StringField.__init__(self, 16103, data)

class NoLinks(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16112)
		else:
			quickfix.IntField.__init__(self, 16112, data)

class LinkID(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16113)
		else:
			quickfix.StringField.__init__(self, 16113, data)

class LinkType(quickfix.CharField):
	def __init__(self, data = None):
		if data == None:
			quickfix.CharField.__init__(self, 16114)
		else:
			quickfix.CharField.__init__(self, 16114, data)

class RelativePriceType(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16116)
		else:
			quickfix.StringField.__init__(self, 16116, data)

class RelativePriceOffset(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16117)
		else:
			quickfix.IntField.__init__(self, 16117, data)

class StartDateTime(quickfix.UtcTimeStampField):
	def __init__(self, data = None):
		if data == None:
			quickfix.UtcTimeStampField.__init__(self, 16118)
		else:
			quickfix.UtcTimeStampField.__init__(self, 16118, data)

class EndDateTime(quickfix.UtcTimeStampField):
	def __init__(self, data = None):
		if data == None:
			quickfix.UtcTimeStampField.__init__(self, 16119)
		else:
			quickfix.UtcTimeStampField.__init__(self, 16119, data)

class EndDateTimeAction(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16120)
		else:
			quickfix.StringField.__init__(self, 16120, data)

class WATType(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16121)
		else:
			quickfix.StringField.__init__(self, 16121, data)

class WATValue(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16122)
		else:
			quickfix.IntField.__init__(self, 16122, data)

class MGNumRetries(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16123)
		else:
			quickfix.IntField.__init__(self, 16123, data)

class MGRetryInterval(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16124)
		else:
			quickfix.IntField.__init__(self, 16124, data)
...
class TriggerQtyType(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16127)
		else:
			quickfix.StringField.__init__(self, 16127, data)

class TriggerQtyOperator(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16128)
		else:
			quickfix.StringField.__init__(self, 16128, data)

class TriggerQty(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16129)
		else:
			quickfix.IntField.__init__(self, 16129, data)

class TrailingOffset(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16130)
		else:
			quickfix.IntField.__init__(self, 16130, data)

class TrailingPriceType(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16131)
		else:
			quickfix.StringField.__init__(self, 16131, data)

class OrderOriginationID(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16142)
		else:
			quickfix.StringField.__init__(self, 16142, data)

class ExchangeOrderID(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16143)
		else:
			quickfix.StringField.__init__(self, 16143, data)

class DisclosedQtyValue(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16144)
		else:
			quickfix.IntField.__init__(self, 16144, data)

class DisclosedQtyVariance(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16145)
		else:
			quickfix.IntField.__init__(self, 16145, data)

class SlicerIntervalValue(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16147)
		else:
			quickfix.IntField.__init__(self, 16147, data)

class SlicerIntervalUnit(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16148)
		else:
			quickfix.StringField.__init__(self, 16148, data)

class DurationType(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16149)
		else:
			quickfix.StringField.__init__(self, 16149, data)

class DurationValue(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16150)
		else:
			quickfix.IntField.__init__(self, 16150, data)

class DurationUnit(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16151)
		else:
			quickfix.StringField.__init__(self, 16151, data)

class DurationBeginTime(quickfix.UtcTimeStampField):
	def __init__(self, data = None):
		if data == None:
			quickfix.UtcTimeStampField.__init__(self, 16152)
		else:
			quickfix.UtcTimeStampField.__init__(self, 16152, data)

class DurationEndTime(quickfix.UtcTimeStampField):
	def __init__(self, data = None):
		if data == None:
			quickfix.UtcTimeStampField.__init__(self, 16153)
		else:
			quickfix.UtcTimeStampField.__init__(self, 16153, data)

class LeftActionTrigger(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16154)
		else:
			quickfix.StringField.__init__(self, 16154, data)

class LeftAction(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16155)
		else:
			quickfix.StringField.__init__(self, 16155, data)

class LeftPayupTicks(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16156)
		else:
			quickfix.IntField.__init__(self, 16156, data)

class MarketOrderLimit(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16157)
		else:
			quickfix.IntField.__init__(self, 16157, data)

class RealizedPandL(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16210)
		else:
			quickfix.StringField.__init__(self, 16210, data)

class ExchContractSymbol(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16309)
		else:
			quickfix.StringField.__init__(self, 16309, data)

class PriceDisplayType(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16451)
		else:
			quickfix.IntField.__init__(self, 16451, data)

class TickSize(quickfix.DoubleField):
	def __init__(self, data = None):
		if data == None:
			quickfix.DoubleField.__init__(self, 16452)
		else:
			quickfix.DoubleField.__init__(self, 16452, data)

class PointValue(quickfix.DoubleField):
	def __init__(self, data = None):
		if data == None:
			quickfix.DoubleField.__init__(self, 16454)
		else:
			quickfix.DoubleField.__init__(self, 16454, data)

class SecurityAltID_ISIN(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16455)
		else:
			quickfix.StringField.__init__(self, 16455, data)

class NumTickTblEntries(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16456)
		else:
			quickfix.IntField.__init__(self, 16456, data)

class NumTicks(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16457)
		else:
			quickfix.IntField.__init__(self, 16457, data)

class MaxPrice(quickfix.DoubleField):
	def __init__(self, data = None):
		if data == None:
			quickfix.DoubleField.__init__(self, 16458)
		else:
			quickfix.DoubleField.__init__(self, 16458, data)

class DeliveryUnit(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16460)
		else:
			quickfix.IntField.__init__(self, 16460, data)

class LotSize(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16461)
		else:
			quickfix.IntField.__init__(self, 16461, data)

class Blocks(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16463)
		else:
			quickfix.IntField.__init__(self, 16463, data)

class TradesInFlow(quickfix.CharField):
	def __init__(self, data = None):
		if data == None:
			quickfix.CharField.__init__(self, 16464)
		else:
			quickfix.CharField.__init__(self, 16464, data)

class PassiveAggressive(quickfix.CharField):
	def __init__(self, data = None):
		if data == None:
			quickfix.CharField.__init__(self, 16480)
		else:
			quickfix.CharField.__init__(self, 16480, data)

class AutoAggressive(quickfix.BoolField):
	def __init__(self, data = None):
		if data == None:
			quickfix.BoolField.__init__(self, 16481)
		else:
			quickfix.BoolField.__init__(self, 16481, data)

class MDEntryState(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16486)
		else:
			quickfix.IntField.__init__(self, 16486, data)

class MDEntrySizeType(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16487)
		else:
			quickfix.StringField.__init__(self, 16487, data)

class AggressorSide(quickfix.CharField):
	def __init__(self, data = None):
		if data == None:
			quickfix.CharField.__init__(self, 16488)
		else:
			quickfix.CharField.__init__(self, 16488, data)

class ExactNumOrdersIndicator(quickfix.CharField):
	def __init__(self, data = None):
		if data == None:
			quickfix.CharField.__init__(self, 16489)
		else:
			quickfix.CharField.__init__(self, 16489, data)

class ExchTickSize(quickfix.DoubleField):
	def __init__(self, data = None):
		if data == None:
			quickfix.DoubleField.__init__(self, 16552)
		else:
			quickfix.DoubleField.__init__(self, 16552, data)

class ExchPointValue(quickfix.DoubleField):
	def __init__(self, data = None):
		if data == None:
			quickfix.DoubleField.__init__(self, 16554)
		else:
			quickfix.DoubleField.__init__(self, 16554, data)

class DropCopyOrder(quickfix.BoolField):
	def __init__(self, data = None):
		if data == None:
			quickfix.BoolField.__init__(self, 16566)
		else:
			quickfix.BoolField.__init__(self, 16566, data)
...
class PosReqId(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16710)
		else:
			quickfix.StringField.__init__(self, 16710, data)

class PosMaintRptId(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16721)
		else:
			quickfix.StringField.__init__(self, 16721, data)
...
class TotalNumOrders(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 16728)
		else:
			quickfix.IntField.__init__(self, 16728, data)

class FFT4(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16901)
		else:
			quickfix.StringField.__init__(self, 16901, data)

class FFT5(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16902)
		else:
			quickfix.StringField.__init__(self, 16902, data)

class FFT6(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 16903)
		else:
			quickfix.StringField.__init__(self, 16903, data)

class RequestTickTable(quickfix.BoolField):
	def __init__(self, data = None):
		if data == None:
			quickfix.BoolField.__init__(self, 17000)
		else:
			quickfix.BoolField.__init__(self, 17000, data)

class ForceLogout(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 18000)
		else:
			quickfix.IntField.__init__(self, 18000, data)

class GatewayStatusReqId(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 18200)
		else:
			quickfix.StringField.__init__(self, 18200, data)

class NoGatewayStatus(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 18201)
		else:
			quickfix.IntField.__init__(self, 18201, data)

class GatewayStatus(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 18202)
		else:
			quickfix.IntField.__init__(self, 18202, data)

class ExchangeGateway(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 18203)
		else:
			quickfix.StringField.__init__(self, 18203, data)

class SubExchangeGateway(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 18204)
		else:
			quickfix.IntField.__init__(self, 18204, data)

class TTAccountType(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 18205)
		else:
			quickfix.StringField.__init__(self, 18205, data)

class NoGateways(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 18206)
		else:
			quickfix.IntField.__init__(self, 18206, data)

class TTSecurityAlias(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 18207)
		else:
			quickfix.StringField.__init__(self, 18207, data)

class TTStrategyEngine(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 18208)
		else:
			quickfix.StringField.__init__(self, 18208, data)

class PriceFeedStatus(quickfix.IntField):
	def __init__(self, data = None):
		if data == None:
			quickfix.IntField.__init__(self, 18210)
		else:
			quickfix.IntField.__init__(self, 18210, data)

class DeliveryTerm(quickfix.CharField):
	def __init__(self, data = None):
		if data == None:
			quickfix.CharField.__init__(self, 18211)
		else:
			quickfix.CharField.__init__(self, 18211, data)

class UnderlyingDeliveryTerm(quickfix.CharField):
	def __init__(self, data = None):
		if data == None:
			quickfix.CharField.__init__(self, 18212)
		else:
			quickfix.CharField.__init__(self, 18212, data)

class IncludeHistoricalFills(quickfix.CharField):
	def __init__(self, data = None):
		if data == None:
			quickfix.CharField.__init__(self, 18213)
		else:
			quickfix.CharField.__init__(self, 18213, data)

class IncludeNumberOfOrders(quickfix.CharField):
	def __init__(self, data = None):
		if data == None:
			quickfix.CharField.__init__(self, 18214)
		else:
			quickfix.CharField.__init__(self, 18214, data)

class ExchCred(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 18216)
		else:
			quickfix.StringField.__init__(self, 18216, data)

class BrokerID(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 18220)
		else:
			quickfix.StringField.__init__(self, 18220, data)

class CompanyID(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 18221)
		else:
			quickfix.StringField.__init__(self, 18221, data)

class TTCustomerName(quickfix.StringField):
	def __init__(self, data = None):
		if data == None:
			quickfix.StringField.__init__(self, 18218)
		else:
			quickfix.StringField.__init__(self, 18218, data)
